...
?>
<div class="col-lg-9">
<h2 class="text-center bg-primary text-white p-2">Update Details</h2>
   ...
   <div class="col-lg-8 ml-8">
        <form action="" method="POST" class="p-5" style="box-shadow: 0px 7px 5px #888888;" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php if(isset($row["doc_email"])){echo $row["doc_email"]; } ?>" name="doc_email" id="" placeholder="Doctor Email" required readonly>
            </div>
            <div class="form-group">
