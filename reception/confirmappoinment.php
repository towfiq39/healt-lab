...
if (isset($_REQUEST['delete'])) {
	...
	$msg = "<div class='container alert alert-danger col-sm-8 mt-2 p-3'>
		...
		<form  method='POST' >
			...
			<a href='confirmappoinment.php' class='btn btn-primary'>Ops No Thanks</a>
		</form>
	</div>"
...
<section class="bg-primary text-white container-fluid p-4 mb-2">
    <div class="row">
        ...
        <div class="col-lg-3 ml-auto">
            <form class="form-inline" action="active_search.php" method="POST">
...
<div class="row container-fluid" >
    <div class="col-lg-3">
        <div class="list-group">
            <a class="list-group-item " href="viewappoinment.php">
	            <i class="fas fa-user"></i>
	           Pending Appoinment
            </a>
            <a class="list-group-item active" href="confirmappoinment.php">
	            <i class="fas fa-user"></i>
 ...
 $sql="select * from book_appoinment where confirmation='active'";
